...
>
> 🔄 **آخر جلسة (2026-07-05):** أُعيد بناء **الرسم والتحرير على الخريطة من الصفر**
> (commit `e4d4cff`): ملفات جديدة `src/lib/mapDraw.js` + `MapDrawLayer.jsx` +
> `VertexEditLayer.jsx` وجراحة في `WarehouseMap.jsx`. ثلاث أدوات (⬜ مستطيل بالسحب ·
> ⬠ مضلّع بالنقاط · 🧱 جدار يُنشأ فور الإنهاء) + معاينة حيّة + قياسات بالمتر على كل
> ضلع + ∟ تعامد 45° + التقاط لرؤوس الأشكال + ⬡ محرّر نقاط للأشكال القائمة (حفظ
> صريح) + ↶ تراجع/Ctrl+Z + توليد حروف تلقائي للعناصر الهيكليّة (A..Z ثم W2..).
> **`migration_20` مُطبَّقة ✅ (2026-07-06)** — الأشكال والجدران تُحفَظ في القاعدة.
> أُضيف لاحقاً: لصق جدار بجدار (التقاط لحوافّ الأشكال مع 🧲) · إغلاق مسار الجدار
> بالضغط على نقطته الأولى · التقاط اختياري (مطفأ افتراضيّاً) · تصغير الجدران حتى 1%.
> المتبقّي: المؤسّس يرسم المكتب بنفسه ثم يضيف مساحات التخزين.
> للجلسة السابقة (2026-06-29) اقرأ `HANDOFF_2026-06-29.md`.
...
| الموقع | القيمة |
|:---|:---|
| الموقع المباشر | `https://sraj-warehouse.vercel.app` ✅ (تحقّق 2026-07-05 — العنوان القديم `sraj-warehouse-nine` ميّت: DEPLOYMENT_NOT_FOUND) |
